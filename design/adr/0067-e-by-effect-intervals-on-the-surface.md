...
- **Status:** PROPOSED, gated on study `2026-09-e-by-surface` (`design/research/2026-09-e-by-surface/PREREGISTRATION.md` §4); the results append below records the outcome.
- **Date:** 2026-09-03
